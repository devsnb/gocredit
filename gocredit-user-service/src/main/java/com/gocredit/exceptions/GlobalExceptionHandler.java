...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleUserAlreadyExitsException(UserAlreadyExitsException ex) {
    ...
    public ResponseEntity<Object> handleCreditCardNotFoundException(CreditCardNotFoundException ex) {
