...
public class GocreditBillServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User user = new User("Saranya", LocalDate.parse("1999-03-27"), "saranya@gmail.com", "saran", 9876543210L,
				Role.USER, address, new HashSet<>());
		...
		CreditCard card = new CreditCard("Snehnagshu", "1234098765456789", CardType.MASTERCARD,
				LocalDate.parse("2025-10-31"), new HashSet<>(Arrays.asList(bill)), savedUser);
